...
class Ic_InternationalCheckout_Block_International extends Mage_Core_Block_Template {
	...
	function shippingPrice () {
		...
		if(stristr(Mage::getStoreConfig('checkout/internationalcheckout/shipping_method'),'fedex') ){
			$shippingMethod = str_replace( 'fedex_', '',  Mage::getStoreConfig('checkout/internationalcheckout/shipping_method') );
		}else{
