...
class AM_RevSlider_Block_Slider_Preview extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface{
    ...
    public function renderResponsiveStyle($slider){
        ...
        $output = "<div><style type='text/css' scoped>";
    ...
    public function renderJs($slider){
        ...
        $scripts[] = Mage::getBaseUrl('js').'am/revslider/rs-plugin/js/jquery.themepunch.tools.min.js';
        ...
        foreach ($styles as $style){
            $html .= "<link type='text/css' property='stylesheet' rel='stylesheet' href='{$style}'/>\r\n";
        }
        ...
        $html .= "
            ...
            spinnerBg: '{$this->_cleanColor($spinnerColor)}',
     ...
     /*    switch ($spinner){
            case 1:
            case 2:
                $html .= "<div><style type='text/css' scoped>";
