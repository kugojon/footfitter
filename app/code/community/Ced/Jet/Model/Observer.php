...
public function getTrackingNumber(Varien_Event_Observer $observer)
    {
        ...
        if($jetorderid){           
            ...
            $days_to_return = (int) trim(Mage::getStoreConfig('jet_options/ced_jetaddress/jet_return_days'));
            if(empty($days_to_return) || !is_numeric($days_to_return)) {
    ...
    public function createOrder()
    {
        ...
        if (isset($response['order_urls']) && count($response['order_urls']) > 0) {
            ...
            foreach ($response['order_urls'] as $jetorderurl) {
                ...
                $email= Mage::getStoreConfig('jet_options/ced_jet/jet_customer_email');
