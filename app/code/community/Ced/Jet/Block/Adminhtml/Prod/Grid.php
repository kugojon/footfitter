...
class Ced_Jet_Block_Adminhtml_Prod_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
       /* $this->addColumn(
        ...
        $this->addColumn(
            'profile_id', array(
                'header' => Mage::helper('catalog')->__('Profile Code'),
                'align' => 'left',
                'type' => 'options',
                'options' => $this->getOptionsForProfile(),
                'index' => 'profile_id',
            )
        );
 ...
 public function filterCallback($collection, $column)
 {
    ...
    public function getOptionsForProfile() {
        ...
        foreach($collection as $profile) {
            $data[$profile->getId()] = $profile->getProfileName();
        }
        return $data;
    }
}
