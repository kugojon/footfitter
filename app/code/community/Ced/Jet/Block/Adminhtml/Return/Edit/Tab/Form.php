                ...
                foreach ($skus_details as $detail) {
                    ...
                    if ($flag) {
                        ...
                        $html4 = '<script type="text/javascript">' .
                            ...
                            'parent_tr = document.getElementById("return_refundfeedback' . $i . '").parentNode.parentNode;' .
                            'span=parent_tr.getElementsByTagName("span");' .
                    ...
                    if ($flag) {
                        $fieldset1->addField(
                            'return_refundfeedback' . $i, 'text', array(
                        ...
                        $fieldset1->addField(
                            'return_refundfeedback' . $i, 'select', array(
                                'label' => Mage::helper('jet')->__('Return Feedback'),
                                'class' => 'required-entry validate-select',
                                'required' => true,
                                'name' => "sku_details[sku$i][return_refundfeedback]",
                    ...
                    $fieldset1->addField(
                        'actual_amount' . $i, 'hidden', array(
                            'name' => "sku_details[sku$i][return_actual_principal]",
                            'value' => ($detail["return_principal"] != "" ? $detail["return_principal"] : 0),
                        )
                    );
                    $fieldset1->addField(
                        'shipping_cost' . $i, 'text', array(
