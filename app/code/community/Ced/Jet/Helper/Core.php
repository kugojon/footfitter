...
class Ced_Jet_Helper_Core extends Mage_Core_Helper_Abstract
{
    ...
    */
    ...
    {
        $this->_allowedFeedType =  explode(',', Mage::getStoreConfig(Ced_Jet_Model_Feed::XML_FEED_TYPES));
    }
    ...
    public function getCedCommerceExtensions($asString = false) 
    {
        ...
        $allModules = Mage::app()->getConfig()->getNode(Ced_Jet_Model_Feed::XML_PATH_INSTALLATED_MODULES);
    ...
    public function getEnvironmentInformation() 
    {
        ...
        $info['feed_types'] = Mage::getStoreConfig(Ced_Jet_Model_Feed::XML_FEED_TYPES);
