    ...
    protected function _prepareLayout()
    {
        ...
        if ($headBlock) {
            ...
            if ($this->helper('catalog/product')->canUseCanonicalTag()) {
                ...
                $pattern        = 'https://';
                $replacement    = 'http://';
                $urlproduct = $product->getUrlModel()->getUrl($product, $params);
                $urlproductnew = str_replace($replacement,$pattern,$urlproduct);
                $headBlock->addLinkRel('canonical', $urlproductnew);
            }
        }
