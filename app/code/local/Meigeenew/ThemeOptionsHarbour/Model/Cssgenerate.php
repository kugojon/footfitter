...
class Meigee_ThemeOptionsHarbour_Model_Cssgenerate extends Mage_Core_Model_Abstract
{
    ...
    private function setParams () {
		...
		$this->timerColors = Mage::getStoreConfig('meigee_harbour_design/price_countdown');
...
$css .= '
body{
    font-family: '. $this->appearance['gfontmain'] .', sans-serif!important; 
...
.timer-wrapper.full .title {
    font-family: '. $this->appearance['gfont'] .', sans-serif!important; 
...
.cms-no-route .page-not-found h2,
.cms-no-route .page-not-found h3,
.timer-wrapper.full .title {font-family: ' . $this->appearance['gfont'] .', sans-serif!important;}';
    }
}
...
/*====== Parallax Banners ======*/
.parallax-banners-wrapper .text-banner .banner-content h2 {color: #' . $this->parallaxBannersColors['colors1_h2'] . ';}
.parallax-banners-wrapper .text-banner .banner-content h3 {color: #' . $this->parallaxBannersColors['colors1_h3'] . ';}
.parallax-banners-wrapper .text-banner .banner-content h4 {color: #' . $this->parallaxBannersColors['colors1_h4'] . ';}
.parallax-banners-wrapper .text-banner .banner-content p {color: #' . $this->parallaxBannersColors['colors1_p'] . ';}
.parallax-banners-wrapper .text-banner .banner-content .divider {background-color: #' . $this->parallaxBannersColors['colors1_divider'] . ';}
...
.parallax-banners-wrapper .text-banner .banner-content .parallax-btn:hover span span {
	color: #' . $this->parallaxBannersColors['colors1_button_text'] . ';
	background: none;
}
.parallax-banners-wrapper .text-banner .banner-content button:hover > span,
.parallax-banners-wrapper .text-banner .banner-content .parallax-btn > span {border-color: #' . $this->parallaxBannersColors['colors1_button_border_h'] . ';}
...
.parallax-banners-wrapper .text-banner .banner-content .parallax-btn span span {
	...
	color: #' . $this->parallaxBannersColors['colors1_button_text_h'] . ';
}
.parallax-banners-wrapper .text-banner .banner-content.colors-2 h2 {color: #' . $this->parallaxBannersColors['colors2_h2'] . ';}
.parallax-banners-wrapper .text-banner .banner-content.colors-2 h3 {color: #' . $this->parallaxBannersColors['colors2_h3'] . ';}
.parallax-banners-wrapper .text-banner .banner-content.colors-2 h4 {color: #' . $this->parallaxBannersColors['colors2_h4'] . ';}
.parallax-banners-wrapper .text-banner .banner-content.colors-2 .divider {background-color: #' . $this->parallaxBannersColors['colors2_divider'] . ';}
.parallax-banners-wrapper .text-banner .banner-content.colors-2 p {color: #' . $this->parallaxBannersColors['colors2_p'] . ';}
...
.parallax-banners-wrapper .text-banner .banner-content.colors-2 .parallax-btn:hover span span {
	color: #' . $this->parallaxBannersColors['colors2_button_text'] . ';
	background: none;
}
.parallax-banners-wrapper .text-banner .banner-content.colors-2 button:hover > span,
.parallax-banners-wrapper .text-banner .banner-content.colors-2 .parallax-btn > span {border-color: #' . $this->parallaxBannersColors['colors2_button_border_h'] . ';}
...
.parallax-banners-wrapper .text-banner .banner-content.colors-2 .parallax-btn span span {
	...
	color: #' . $this->parallaxBannersColors['colors2_button_text_h'] . ';
}
