...
var ConfigurableMediaImages = {
    ...
    getSwatchImage: function(productId, optionLabel, selectedLabels) {
		...
		//Product Sku change
		if(fallback['option_labels'][optionLabel] && jQuery('.product-view .sku').length){
			key = fallback['option_labels'][optionLabel]['products'][0];
			sku = skuArray[key];
			jQuery('.product-view .sku span').html(sku);
		}
